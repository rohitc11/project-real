  ...
  return (
    ...
    >
      <a
        ...
        className={cn(
          "flex size-11 items-center justify-center rounded-full border border-line bg-surface-2/90 text-fg shadow-lg shadow-black/40 backdrop-blur transition-all duration-300 hover:border-accent/60 hover:text-accent",
      ...
      <div className="flex items-center gap-2">
        <button
          ...
          className="flex size-9 items-center justify-center rounded-full border border-line bg-surface-2/80 text-subtle backdrop-blur transition-colors hover:text-fg"
        >
          <svg
            viewBox="0 0 12 12"
        ...
        <a
          ...
          className="group flex h-12 items-center gap-2.5 rounded-full bg-accent pl-4 pr-5 text-sm font-medium text-accent-ink shadow-[0_10px_40px_-12px_var(--brand-accent-glow)] transition-all duration-300 hover:bg-accent-hi"
        >
